...
internal class EnvelopeTest {
    ...
    fun happyPath() {
        ...
        assertEquals(publicKey, envelope.publicKey, "envelope has unexpected public key")
        assertArrayEquals(envelope.payloadType, SimpleRecord.codec, "PayloadType does not match record Codec")
        ...
        assertArrayEquals(payload, deserialized.envelope.rawPayload, "payload of envelope does not match input")
