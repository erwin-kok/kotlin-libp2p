...
//            val actual = connectionPair.remote.input.readYamuxFrame().expectNoErrors()
...
//            connectionPair.remote.output.writeYamuxFrame(MessageFrame(YamuxStreamId(true, id), buildPacket(pool) { writeFully(random1) }))
//            connectionPair.remote.output.flush()
...
//            assertNewStreamFrameReceived(it, "newStreamName$it", connectionPair.remote)
//            val random1 = Random.nextBytes(1000)
//            connectionPair.remote.output.writeYamuxFrame(MessageFrame(YamuxStreamId(false, it.toLong()), buildPacket(pool) { writeFully(random1) }))
//            connectionPair.remote.output.flush()
//            assertFalse(muxedStream.input.isClosedForRead)
//            val random2 = ByteArray(random1.size)
//            muxedStream.input.readFully(random2)
...
//        assertFalse(muxedStream.input.isClosedForRead)
//        assertFalse(muxedStream.output.isClosedForWrite)
//        connectionPair.remote.output.writeYamuxFrame(CloseFrame(YamuxStreamId(true, id)))
//        connectionPair.remote.output.flush()
...
//            assertFalse(muxedStream.input.isClosedForRead)
//            assertFalse(muxedStream.output.isClosedForWrite)
//            connectionPair.remote.output.writeYamuxFrame(CloseFrame(YamuxStreamId(false, it.toLong())))
//            connectionPair.remote.output.flush()
//            val exception = assertThrows<ClosedReceiveChannelException> {
//                muxedStream.input.readPacket(10)
//            }
...
//        val connectionPair = TestConnection(pool)
//        val muxa = YamuxStreamMuxerConnection(Session(this, YamuxConfig(), connectionPair.local, true))
//        val muxb = YamuxStreamMuxerConnection(Session(this, YamuxConfig(), connectionPair.remote, false))
//        repeat(100) {
...
//        val muxa = YamuxStreamMuxerConnection(Session(this, YamuxConfig(), pipe.local, true))
//        val muxb = YamuxStreamMuxerConnection(Session(this, YamuxConfig(), pipe.remote, false))
//        repeat(100) {
...
//        val pipe = TestConnection(pool)
//        val mux = YamuxStreamMuxerConnection(Session(this, YamuxConfig(), pipe.local, true))
//        val job = launch {
